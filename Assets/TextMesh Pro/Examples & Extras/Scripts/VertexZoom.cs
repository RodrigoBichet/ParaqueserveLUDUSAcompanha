        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < textInfo.meshInfo.Length; i++)
                {
                    ...
                    // Converte manualmente de Vector4[] (uvs0) para Vector2[] (uv)
                    Vector4[] tempUVs4 = textInfo.meshInfo[i].uvs0;
                    Vector2[] tempUVs2 = new Vector2[tempUVs4.Length];

                    for (int j = 0; j < tempUVs4.Length; j++)
                    {
                        tempUVs2[j] = new Vector2(tempUVs4[j].x, tempUVs4[j].y);
                    }

                    textInfo.meshInfo[i].mesh.uv = tempUVs2;
